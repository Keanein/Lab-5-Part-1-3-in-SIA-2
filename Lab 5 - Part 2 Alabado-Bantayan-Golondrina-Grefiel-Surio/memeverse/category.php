<?php
// category.php - PHASE 5 PROFESSOR'S VERSION
    ...
    <div class="col-lg-6">
        ...
        <div class="profile-header mb-4">
            <div class="d-flex align-items-center gap-3">
                <div class="category-header-emoji" style="font-size: 3rem;">
                    <?= $category_emoji ?>
                </div>
                <div>
        ...
        <?php else: ?>
            ...
            <?php if (count($initial_posts) === $limit): ?>
                <div class="load-more-wrapper">
                    <button class="load-more-btn" id="load-more-btn" data-last-id="<?= $last_post_id ?>" data-category-id="<?= $category_id ?>">
...
if (loadMoreBtn) {
    loadMoreBtn.addEventListener('click', async function() {
        ...
        try {
            ...
            const response = await fetch(`${siteBase}api/posts.php?page=${currentPage}&limit=10&last_id=${lastId}&category_id=${categoryId}`);
            ...
            if (posts.length > 0) {
                ...
                if (posts.length < 10 || newPostsCount === 0) {
                    ...
                    this.disabled = false;
                    this.innerHTML = '<i class="bi bi-arrow-repeat"></i> Load More <?= escape($category_name) ?> Memes';
                }
            } else {
                this.style.display = 'none';
            }
